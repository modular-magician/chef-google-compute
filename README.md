...
* `interconnect` -
  Required. URL of the underlying Interconnect object that this attachment's
  traffic will
  traverse through.
...
* `private_interconnect_info` -
  ...
  InterconnectAttachment. This property
  is populated if the interconnect that this is attached to is of type
  DEDICATED.

* `private_interconnect_info/tag8021q`
  Output only. [Output Only] 802.1q encapsulation tag to be used for traffic
  between
...
* `router` -
  Required. URL of the cloud router to be used for dynamic routing. This
  router must be in
