...
* `tunnels` -
  Output only. A list of references to VpnTunnel resources associated to this
  VPN gateway.

* `forwarding_rules` -
  Output only. A list of references to the ForwardingRule resources
  associated to this VPN
  gateway.
...
* `shared_secret` -
  Required. Shared secret used to set the secure session between the Cloud
  VPN
