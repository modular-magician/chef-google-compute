  ...
  module GCOMPUTE
    ...
    class TargetVpnGateway < Chef::Resource
      ...
      property :tunnels,
               ...
               desired_state: true
      # forwarding_rules is Array of
      # Google::Compute::Property::ForwRuleSelfLinkRefArray
      property :forwarding_rules,
               Array,
               coerce: \
                 ::Google::Compute::Property::ForwRuleSelfLinkRefArray.coerce,
               desired_state: true
      property :region,
      ...
      action :create do
        ...
        if fetch.nil?
          converge_by ['Creating gcompute_target_vpn_gateway',
      ...
      action :delete do
        fetch = fetch_resource(@new_resource, self_link(@new_resource),
                               'compute#targetVpnGateway')
        unless fetch.nil?
          converge_by ['Deleting gcompute_target_vpn_gateway',
                       "[#{new_resource.name}]"].join do
