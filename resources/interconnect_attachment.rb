  ...
  module GCOMPUTE
    ...
    class InterconnectAttachment < Chef::Resource
      ...
      property :private_interconnect_info,
               [Hash, ::Google::Compute::Data::InteAttaPrivInteInfo],
               coerce: ::Google::Compute::Property::InteAttaPrivInteInfo.coerce,
               desired_state: true
      ...
      action :create do
        ...
        if fetch.nil?
          converge_by ['Creating gcompute_interconnect_attachment',
          ...
          @current_resource.private_interconnect_info =
            ::Google::Compute::Property::InteAttaPrivInteInfo.api_parse(
              fetch['privateInterconnectInfo']
            )
          @current_resource.google_reference_id =
            ::Google::Compute::Property::String.api_parse(
              fetch['googleReferenceId']
            )
          @current_resource.operational_status =
            ::Google::Compute::Property::String.api_parse(
              fetch['operationalStatus']
            )
          @current_resource.router =
            ::Google::Compute::Property::String.api_parse(fetch['router'])
          @current_resource.creation_timestamp =
            ::Google::Compute::Property::Time.api_parse(
              fetch['creationTimestamp']
            )
          @current_resource.id =
            ::Google::Compute::Property::String.api_parse(fetch['id'])
      ...
      action :delete do
        fetch = fetch_resource(@new_resource, self_link(@new_resource),
                               'compute#interconnectAttachment')
        unless fetch.nil?
          converge_by ['Deleting gcompute_interconnect_attachment',
                       "[#{new_resource.name}]"].join do
