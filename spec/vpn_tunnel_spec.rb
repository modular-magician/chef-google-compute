        ...
        context 'title != name' do
          ...
          context 'title != name (pass)' do
            ...
            context 'gcompute_vpn_tunnel[title0]' do
              ...
              it do
                is_expected.to have_attributes(vt_label: 'test name#0 data')
              end
            ...
            context 'gcompute_vpn_tunnel[title1]' do
              ...
              it do
                is_expected.to have_attributes(vt_label: 'test name#1 data')
              end
            ...
            context 'gcompute_vpn_tunnel[title2]' do
              ...
              it do
                is_expected.to have_attributes(vt_label: 'test name#2 data')
              end
    ...
    context 'resource missing' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it do
            is_expected
              .to have_attributes(shared_secret: 'test shared_secret#0 data')
          end
          ...
          it do
            is_expected
              .to have_attributes(local_traffic_selector: %w[jj kk ll mm nn])
          end
