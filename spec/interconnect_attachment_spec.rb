          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_interconnect_attachment gcompute_region],
            ...
            context 'gcompute_interconnect_attachment[title0]' do
              subject do
                chef_run.find_resource(:gcompute_interconnect_attachment,
                                       'title0')
              end
        ...
        context 'title != name' do
          ...
          context 'title != name (pass)' do
            ...
            context 'gcompute_interconnect_attachment[title0]' do
              ...
              it do
                is_expected.to have_attributes(ia_label: 'test name#0 data')
              end
            ...
            context 'gcompute_interconnect_attachment[title1]' do
              ...
              it do
                is_expected.to have_attributes(ia_label: 'test name#1 data')
              end
            ...
            context 'gcompute_interconnect_attachment[title2]' do
              ...
              it do
                is_expected.to have_attributes(ia_label: 'test name#2 data')
              end
