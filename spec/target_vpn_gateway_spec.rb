          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gcompute_target_vpn_gateway gcompute_region
                              gcompute_forwarding_rule gcompute_network],
        ...
        context 'title != name' do
          ...
          context 'title != name (pass)' do
            ...
            context 'gcompute_target_vpn_gateway[title0]' do
              ...
              it do
                is_expected.to have_attributes(tvg_label: 'test name#0 data')
              end
            ...
            context 'gcompute_target_vpn_gateway[title1]' do
              ...
              it do
                is_expected.to have_attributes(tvg_label: 'test name#1 data')
              end
            ...
            context 'gcompute_target_vpn_gateway[title2]' do
              ...
              it do
                is_expected.to have_attributes(tvg_label: 'test name#2 data')
              end
